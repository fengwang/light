...
class SystemService {
  ...
  Future<PermissionStatus> requestPermission(permission) => SimplePermissions.requestPermission(permission);
  //Future<bool> requestPermission(permission) => SimplePermissions.requestPermission(permission);
